    ...
    module Responder
      module Dispatcher
        ...
        VALID_COMMANDS = [
          ...
          'COMMENT-LIKE-DELETE', 'FOREST', 'INTRODUCE', 'MEMBER', 'MEMBER-DELETE',
          'MESSAGE', 'POOL', 'POOL-DELETE', 'POOL-POST', 'POOL-POST-DELETE', 'POST',
        ...
        def process(request_raw)
          ...
          if ! VALID_COMMANDS.include?(command)
            ...
            elsif introduced? && authenticated? && ! in_a_forest? && command != 'FOREST'
